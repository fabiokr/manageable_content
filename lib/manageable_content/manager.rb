module ManageableContent
  class Manager
    ...
    class << self
      ...
      #
      def page(key, locale = I18n.locale)
        Page.with_contents
            .where(:key => key)
            .where(:locale => locale)
      end
      ...
      #
      def generate_page!(key, locale, content_keys)
